    ...
    <SectionWrapper className="bg-dark-card/30">
      ...
      >
        ...
        <motion.div variants={fadeUp} className="rounded-2xl border border-dark-border bg-dark-card p-6">
          ...
          <ul className="space-y-3">
            <li className="flex items-center justify-between"><span className="text-beige flex items-center gap-2"><Users className="h-4 w-4 text-gold" /> Project Wallet 1</span><span className="text-gold font-bold">2%</span></li>
            <li className="flex items-center justify-between"><span className="text-beige flex items-center gap-2"><Users className="h-4 w-4 text-gold" /> Project Wallet 2</span><span className="text-gold font-bold">2%</span></li>
            <li className="flex items-center justify-between"><span className="text-beige flex items-center gap-2"><Users className="h-4 w-4 text-gold" /> Project Wallet 3</span><span className="text-gold font-bold">2%</span></li>
            <li className="flex items-center justify-between"><span className="text-beige flex items-center gap-2"><Users className="h-4 w-4 text-gold" /> Project Wallet 4</span><span className="text-gold font-bold">2%</span></li>
          </ul>
        </motion.div>
      </motion.div>
    </SectionWrapper>
