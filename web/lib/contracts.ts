...
// Penny auction — DEPLOYED on BSC mainnet (v2 with refund protection)
export const AUCTION_ADDRESS = (process.env.NEXT_PUBLIC_AUCTION_ADDRESS || '0x9702D5C9B6F82f4F2d312f9a1FBA0f6FE75F3730') as `0x${string}`;
